...
Now prepare data for cox analysis and survival plots for survminer.
```{r}
...
model_1_anova <- car::Anova(model_10e9)
model_1_anova
```
...
compare_wolbachia = emmeans::emmeans(model_10e9, pairwise~wolbachia|virus)
...
compare_virus = emmeans::emmeans(model_10e9, pairwise~virus|wolbachia)
...
ggforest(model_10e6a, data=data_10e6_cox)
